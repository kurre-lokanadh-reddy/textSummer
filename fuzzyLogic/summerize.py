...
import sys
from . import autoCustomRules as acr
...
def fuzzy_summary (file_name,ABSTRACT_SIZE=0.3,title=False):
    ...
    print("before feature calculation")
    ...
    compressionNumber = total_sentence * ABSTRACT_SIZE
    ...
    for index in result2:
        summery=summery+detected_sentences[index[0]]
    return summery
